...
const Hero = () => (
  <section className="pt-40 pb-20 px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
    ...
    <div className="flex flex-col md:flex-row gap-6 w-full md:w-auto items-center justify-center">
      <a href="https://tinyurl.com/luminadesktop" download className="group relative flex items-center justify-center gap-3 border border-cyan-500 text-cyan-400 px-8 py-4 text-sm font-bold uppercase tracking-wider overflow-hidden min-w-[240px] hover:text-black transition-colors duration-300">
    ...
    <div className="max-w-5xl mx-auto px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="relative border border-cyan-500/30 bg-cyan-950/5 p-8 flex flex-col">
          ...
          <a href="https://tinyurl.com/luminadesktop" download className="w-full py-3 text-center block bg-cyan-400 text-black text-sm font-bold hover:bg-cyan-300 transition-colors">
            DOWNLOAD BETA
          </a>
        </div>
      </div>
